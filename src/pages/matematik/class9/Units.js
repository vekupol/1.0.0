...
function UnitsArea() {
  ...
  return (
    <Container>
    <Icons><IoHomeSharp style={{color: "var(--main-color)"}}/><BsArrowRightShort style={{color: "var(--main-color)"}}/><p>9.Sınıf</p><BsArrowRightShort style={{color: "var(--main-color)"}}/><p>Mantık</p></Icons>
        ...
        <Title><Link to="/kurslar/9-sinif/mantik"><h2> Mantık </h2></Link> </Title>
